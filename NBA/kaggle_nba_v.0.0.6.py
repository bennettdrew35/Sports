...
ax1.hist(first_df3["diff_From_Mean"])
ax1 = plt.title('First Half')
#Second Half difference from Mean
ax2 = fig.add_subplot(222)
ax2.hist(sec_df3["diff_From_Mean"])
ax2 = plt.title('Second Half (Included Overtime)')
#Full Game difference from Mean
ax3 = fig.add_subplot(223)
ax3.hist(full_df3["diff_From_Mean"])
ax3 = plt.title('Full Game')
#Regulation difference from Mean
ax4 = fig.add_subplot(224)
ax4.hist(reg_df3["diff_From_Mean"])
ax4 = plt.title('Time on Court')

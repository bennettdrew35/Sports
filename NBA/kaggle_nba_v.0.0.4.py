...
writer = pd.ExcelWriter('NBA_Info.xlsx', engine='xlsxwriter')
...
first_df3['diff_From_Mean'] = first_df3['first_Half_PTS'] - first_df3['first_Half_PTS_Mean']
...
sec_df3['diff_From_Mean'] = sec_df3['sec_Half_PTS'] - sec_df3['sec_Half_PTS_Mean']
...
full_df3['diff_From_Mean'] = full_df3['full_Game_PTS'] - full_df3['full_Game_PTS_Mean']
...
reg_df3['diff_From_Mean'] = reg_df3['teamMin'] - reg_df3['teamMin_Mean']
